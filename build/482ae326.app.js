...
/***/ function(module, exports, __webpack_require__) {
	...
	var Config = {
		...
		makeUrl: function makeUrl(key, param) {
			var domain = 'http://localhost/signin/api/';
			if (typeof param != "string") {
				param = '?debug=true&uid=1001&orgId=' + _reactCookie2.default.load('orgId');
			} else {
				param = '?debug=true&uid=1001&orgId=' + _reactCookie2.default.load('orgId') + "&" + param;
			}
			switch (key) {
				case "getDaySign":
					{
