...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Record = __webpack_require__(270);

	var _Record2 = _interopRequireDefault(_Record);

	var _Fieldsign = __webpack_require__(388);

	var _Fieldsign2 = _interopRequireDefault(_Fieldsign);

	var _SelectArea = __webpack_require__(389);

	var _SelectArea2 = _interopRequireDefault(_SelectArea);

	var _OrtAnomalie = __webpack_require__(390);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SignList = __webpack_require__(269);
	...
	var App = function (_Component) {
		...
		function App(props) {
			...
			_this2.isLocated = 0;
			_this2.action = 0;
			_this2.state = { disabled: true, localInfo: {}, lnglatXY: null, recordList: null, showText: "正在加载数据...", corpList: [], currCorp: {}, expand: false, isShowSign: false, dialog: 0 };
			return _this2;
		}
	   ...
	   document.documentElement.style.fontSize = document.documentElement.clientWidth / 7.5 + 'px';*/
			...
			value: function initCorp() {
				...
				_config2.default.native("getorglist") /*.then((res)=>{
					...
					var orgId = _reactCookie2.default.load('orgId');
					var currCorp = {};
	   	...
	   	orgId:this.state.currCorp.orgId
				...
				_config2.default.ajax('getTime', '' /*,JSON.stringify(param)*/).then(function (data) {
					...
					if (data.code == 200) {
						_this7.setState({ 'time': data.data.time });
					} else {
				...
				_config2.default.ajax("sign", {
					...
					if (res.code == 200) {
						...
						_this.action = 0; //reset
							...
							//地点异常
							_config2.default.native('confirm', { title: "地点异常", "desc": "当前地点不在公司范围内", "ok": "确定打卡", "cancel": "报告原因" }).then(function (res) {
								if (res.data == "cancel") {
									_this.setLocalStorage();
									location.href = "#ortanomalie";
								} else if (res.data == "ok") {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'div',
								{ className: 'focus', onClick: this.expandOrg.bind(this) },
								this.state.currCorp.orgName,
								' ',
								_react2.default.createElement('i', { className: this.state.expand ? "triangle up" : "triangle down" })
							),
							this.state.expand ? _react2.default.createElement(
								...
								(this.state.corpList || []).map(function (item) {
									return _react2.default.createElement(
										'div',
										{ className: item.orgId == _this9.state.currCorp.orgId ? "focus" : "", onClick: _this9.select.bind(_this9, item) },
										item.orgName
									);
								})
							) : null
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function() {
		...
		qwest = function(method, url, data, options, before) {
			...
			options.withCredentials =true// !!options.withCredentials;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactDayPicker = __webpack_require__(376);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.localeUtils = __webpack_require__(273);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _moment = __webpack_require__(274);
...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function (global, factory) {
	   ...
	   factory(global.moment)
	    ...
	    var monthsShortWithDots = '1月._2月._3月._4月._5月._5月._5月._5月._5月._5月._5月._5月.'.split('_'),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DayPicker = __webpack_require__(377);
	var DateUtils = __webpack_require__(384);
	var LocaleUtils = __webpack_require__(385);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Caption = __webpack_require__(378);
	...
	var _Month = __webpack_require__(381);

	var _Month2 = _interopRequireDefault(_Month);

	var _Day = __webpack_require__(386);

	var _Day2 = _interopRequireDefault(_Day);

	var _Helpers = __webpack_require__(383);

	var Helpers = _interopRequireWildcard(_Helpers);

	var _DateUtils = __webpack_require__(384);

	var DateUtils = _interopRequireWildcard(_DateUtils);

	var _LocaleUtils = __webpack_require__(385);
	...
	var DayPicker = function (_Component) {
	  ...
	  _createClass(DayPicker, [{
	    ...
	    value: function render() {
	      ...
	      var attributes = _objectWithoutProperties(_props2, ['locale', 'canChangeMonth', 'onDayClick']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Weekdays = __webpack_require__(382);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OrtAnomalie = function (_Component) {
		...
		function OrtAnomalie(props) {
			...
			_this2.imgList = [];
			_this2.outInfo = JSON.parse(localStorage.getItem('outInfo'));
			_this2.state = { imgList: [], text: null, maxlength: 50, showUpload: true };
			return _this2;
		}
