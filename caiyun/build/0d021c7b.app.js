...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_Component) {
		...
		function App(props) {
			...
			_this2.action = 0;
			_this2.signType = 0;
			_this2.state = { disabled: true, acute: false, localInfo: {}, lnglatXY: null, recordList: null, showText: "正在加载数据...", corpList: [], currCorp: {}, expand: false, isShowSign: false, dialog: 0 };
			return _this2;
		}
			...
			value: function initMap(e) {
				...
				setTimeout(function () {
					...
					if (!_this3.isLocated) {
						...
						_this3.state.localInfo.status = false;
						_this3.setState({ localInfo: _this3.state.localInfo });
					}
				}, 1000);
				this.isLocated = 0;
	   	...
	   	orgId:this.state.currCorp.orgId
				...
				_config2.default.ajax('getTime', '' /*,JSON.stringify(param)*/).then(function (data) {
					...
					if (data.code == 200) {
						...
						_this7.setState({ 'time': datestring });
					} else {
	      ...
	      Config.native('confirm',{title:"地点异常","desc":"当前地点不在公司范围内","ok":"确定打卡","cancel":"报告原因"}).then((res)=>{
			...
			value: function render() {
				...
				return _react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									{ className: 'mapAdress' },
									function () {
										if (_this9.state.localInfo.status) {
											return _react2.default.createElement(
												'div',
												null,
					...
					_react2.default.createElement(
						'div',
						{ className: this.state.disabled ? "bottomButton bigButton disabled" : "bottomButton bigButton" },
						_react2.default.createElement(
							'div',
						...
						_react2.default.createElement(
							_reactRouter.Link,
							{ to: 'fieldsign', onClick: this.setLocalStorage.bind(this) },
							_react2.default.createElement(
								'div',
								{ className: 'button rbutton' },
			...
			value: function tab(index, date) {
				...
				if (index == 0) {
					_config2.default.ajax('getDaySign', param).then(function (data) {
						_this3.renderList(data.data.list, '您还没有签到哦~');
					});
				} else {
					//他人外勤
					_config2.default.ajax('historyOfDay', param).then(function (data) {
						_this3.renderList(data.data.list, '本日没有他人的外勤记录~');
					});
				}
			}
		}, {
	...
	var Calendar = function (_React$Component) {
		...
		_createClass(Calendar, [{
			...
			value: function onMonthChange(d) {
				var now = new Date(d);
				var dateStr = now.getFullYear() + "年" + now.getMonth() + "月";
				this.setState({ title: dateStr });
		...
		_createClass(OrtAnomalie, [{
			...
			value: function componentDidMount() {
				...
				_config2.default.native('getallmethod').then(function (res) {
					var data = res.data;
					if (data.indexOf('photo') > -1 || data.indexOf('photo1') > -1) {
						_this3.suprise = true;
					}
				});
			}
